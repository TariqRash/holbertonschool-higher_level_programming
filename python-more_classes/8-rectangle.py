#!/usr/bin/python3
"""Module that defines a Rectangle class with comparison.

This module demonstrates static methods by implementing
a comparison function for rectangles based on area.
"""
